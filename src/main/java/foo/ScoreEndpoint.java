...
public class ScoreEndpoint {
	...
	@ApiMethod(name = "myscores", path="myscores/{name}", httpMethod = ApiMethod.HttpMethod.GET)
		public List<Entity> myScores(@Named("name") String name) {
			Query query = new Query("Score").setFilter(new Query.FilterPredicate("name", Query.FilterOperator.EQUAL, name));
			DatastoreService datastore = DatastoreServiceFactory.getDatastoreService();
